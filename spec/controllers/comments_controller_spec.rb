...
RSpec.describe CommentsController, type: :controller do
  ...
  describe 'PUT #update' do
    let(:current_comment) do
      current_post.comments.build(valid_comment_params.merge({ user: current_user, post: current_post }))
    end
    ...
    it 'redirects admin to another page response' do
      ...
      put :update,
          params: { id: current_comment.id, user_id: current_user.id, post_id: current_post.id,
